...
// Command     : write_verilog -force -mode synth_stub -rename_top fp_accum -prefix
//               fp_accum_ floating_point_0_stub.v
...
module fp_accum(aclk, s_axis_a_tvalid, s_axis_a_tready, 
